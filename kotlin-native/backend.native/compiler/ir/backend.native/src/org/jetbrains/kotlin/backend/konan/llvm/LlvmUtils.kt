...
fun LLVMTypeRef.isInteger(): Boolean = llvm.LLVMGetTypeKind(this) == LLVMTypeKind.LLVMIntegerTypeKind

fun LLVMTypeRef.isPointer(): Boolean = llvm.LLVMGetTypeKind(this) == LLVMTypeKind.LLVMPointerTypeKind
