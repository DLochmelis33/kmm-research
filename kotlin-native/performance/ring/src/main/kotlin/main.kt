...
class RingLauncher : Launcher() {
    override val baseBenchmarksSet =
            mutableMapOf(
                    ...
                    "MultithreadedLoops.updateSharedCounterWorkers" to BenchmarkEntryWithInitAndValidation.create(::MultithreadedLoopsBenchmark, { runUpdateSharedCounterWorkers() }, { tearDownWorkers() }),
                    "MultithreadedLoops.updateCounterWorkers" to BenchmarkEntryWithInitAndValidation.create(::MultithreadedLoopsBenchmark, { runUpdateCounterWorkers() }, { tearDownWorkers() }),
                    "MultithreadedLoops.sumSharedArrayWorkers" to BenchmarkEntryWithInitAndValidation.create(::MultithreadedLoopsBenchmark, { runSumSharedArrayWorkers() }, { tearDownWorkers() }),
                    "MultithreadedLoops.sumSharedIntArrayWorkers" to BenchmarkEntryWithInitAndValidation.create(::MultithreadedLoopsBenchmark, { runSumSharedIntArrayWorkers() }, { tearDownWorkers() }),
                    "MultithreadedLoops.sumArrayWorkers" to BenchmarkEntryWithInitAndValidation.create(::MultithreadedLoopsBenchmark, { runSumArrayWorkers() }, { tearDownWorkers() }),
                    "MultithreadedLoops.sumIntArrayWorkers" to BenchmarkEntryWithInitAndValidation.create(::MultithreadedLoopsBenchmark, { runSumIntArrayWorkers() }, { tearDownWorkers() }),
                    "MultithreadedLoops.sumCharArrayWorkers" to BenchmarkEntryWithInitAndValidation.create(::MultithreadedLoopsBenchmark, { runSumCharArrayWorkers() }, { tearDownWorkers() }),
                    "MultithreadedLoops.sumULongArrayWorkers" to BenchmarkEntryWithInitAndValidation.create(::MultithreadedLoopsBenchmark, { runSumULongArrayWorkers() }, { tearDownWorkers() }),
                    "MultithreadedLoops.sumArrayByIndicesWorkers" to BenchmarkEntryWithInitAndValidation.create(::MultithreadedLoopsBenchmark, { runSumArrayByIndicesWorkers() }, { tearDownWorkers() }),
                    "MultithreadedLoops.sumIntArrayByIndicesWorkers" to BenchmarkEntryWithInitAndValidation.create(::MultithreadedLoopsBenchmark, { runSumIntArrayByIndicesWorkers() }, { tearDownWorkers() }),
