...
./build/bin/macosArm64/benchmarksAnalyzerReleaseExecutable/benchmarksAnalyzer.kexe $sources_dir/"$target_pass_name".json $sources_dir/"$baseline_pass_name".json -f -r html -o $result_dir/"$result_filename"
